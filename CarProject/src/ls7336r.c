...
unsigned char BYTE_MODE[] = {ONEBYTE_COUNTER, TWOBYTE_COUNTER, THREEBYTE_COUNTER, FOURBYTE_COUNTER};
char setMDR0[] = {WRITE_MODE0, FOURX_COUNT};
char setMDR1[] = {WRITE_MODE1, FOURBYTE_COUNTER};
char clearStatus[] = {CLEAR_STATUS};
char clearCounter[] = {CLEAR_COUNTER};
char readCounterMsg[] = { READ_COUNTER, 0, 0, 0, 0};
