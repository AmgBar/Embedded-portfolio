...
2.	You are going to measure distance using the Echo Sensor (HC-SR04).  You are to display distance in centimeters in your terminal.  Make sure to show the object moving and the distance on the console when you do your video.  This should be in a loop so as you move the item, the distance is printed on the console.

3.	Select two GPIO pins on the pi to connect the Trigger and Echo pins.

4.	Submit your homework in your GitHub Repository and the PDF (and mp4) on Canvas per the submission details in the attached PDF.
